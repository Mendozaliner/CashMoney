Updated: 2026-07-25 s22 (E31 CAPE Value Tilt DISCARDED&WATCH-LISTED, E32 ERP Carry DISCARDED&CLOSED. 12 new configs (212 total). E31 CT(lo0.50,t85): mean_wf=1.001 (BEST EVER), DD=−12.05% (2ND BEST EVER), DSR=0.988, CI=[−0.348,+1.106] straddles zero, corr_v2=1.000 — CAPE ≥85th-pct for nearly ALL of 2000-2023; tilt is a constant 50% scale not a timing signal. WATCH-LISTED (DD improvement 8.4pp). E32 ERP(lo0.50,erp0.02): mean_wf=0.902, DD=−20.49%, DSR=0.976, CI=[−0.544,+0.943] straddles zero, corr_v2=0.948 — carry signal fires in bull AND bear regimes; no timing edge. DISCARDED&CLOSED. New mark $985.35 (SPY 738.93, +0.102% day, −1.465% all-time). Exposure 1.0; no trades. Guardrails ALL GREEN. v2 significance: DSR=1.0, CI=[−0.0128,+0.7077] unchanged. $1k 2000→2026-07-24: v2 $8,382 > QQQ $6,947 > SPY $6,775 > DIA $6,759 > E32 $6,571 > EWC $5,768 > E31 $4,658. Live-period benchmarks: QQQ −4.93% (portfolio −1.47% outperforms by 3.5pp); DIA/IWM slightly better. NOTE: CAPE data cache ends 2023-09; needs pipeline fix (Roadmap #3).)
